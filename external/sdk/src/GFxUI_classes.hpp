...
public:
	...
	class UGFxObject* CreateObject(const class FString& ASClass, class UGFxObject* optionalType);
	...
	class UGFxObject* GetVariableObject(const class FString& Path, class UGFxObject* optionalType);
...
public:
	...
	bool eventWidgetUnloaded(const class FName& WidgetName, const class FName& WidgetPath, class UGFxObject* Widget);
	bool eventWidgetInitialized(const class FName& WidgetName, const class FName& WidgetPath, class UGFxObject* Widget);
	class UGFxObject* AttachMovie(const class FString& symbolname, const class FString& instancename, int32_t optionalDepth, class UGFxObject* optionalType);
	class UGFxObject* CreateEmptyMovieClip(const class FString& instancename, int32_t optionalDepth, class UGFxObject* optionalType);
	...
	class UGFxObject* GetElementMemberObject(int32_t Index, const class FString& Member, class UGFxObject* optionalType);
	...
	class UGFxObject* GetElementObject(int32_t Index, class UGFxObject* optionalType);
	...
	class UGFxObject* GetObjectW(const class FString& Member, class UGFxObject* optionalType);
...
public:
	...
	class FString                                      SourceFile;                                    // 0x006C (0x000C) [0x0000000800400001] (CPF_Edit | CPF_NeedCtorLink | CPF_EditorOnly)
	...
	class FString                                      SourceFileTimestamp;                           // 0x008C (0x000C) [0x0000000800420001] (CPF_Edit | CPF_EditConst | CPF_NeedCtorLink | CPF_EditorOnly)
	int32_t                                            RTTextures;                                    // 0x0098 (0x0004) [0x0000000000000000]               
	int32_t                                            RTVideoTextures;                               // 0x009C (0x0004) [0x0000000000000000]               
	struct FQWord                                      ImportTimeStamp;                               // 0x00A0 (0x0008) [0x0000000800002002] (CPF_Const | CPF_Transient | CPF_EditorOnly)
...
public:
	...
	class UGFxMoviePlayer*                             MoviePlayerClass;                              // 0x00FC (0x0004) [0x0000000000000001] (CPF_Edit)    
